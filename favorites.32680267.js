!function(){let e;function t(){let e=document.documentElement.getAttribute("data-theme"),t="light"===e?"dark":"light";document.documentElement.setAttribute("data-theme",t);let a=document.querySelectorAll(".input-switcher");a.forEach(function(e){e.checked="dark"===t}),localStorage.setItem("theme",t)}let a=document.querySelectorAll(".input-switcher");a.forEach(function(e){e.addEventListener("change",t)}),function(){let e=localStorage.getItem("theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",a=e||t;document.documentElement.setAttribute("data-theme",a);let i=document.querySelectorAll(".input-switcher");i.forEach(function(e){e.checked="dark"===a})}();var i={};i={trueFunc:function(){return!0},falseFunc:function(){return!1}},(()=>{let e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),a=document.querySelector(".js-close-menu"),n=()=>{let a="true"===t.getAttribute("aria-expanded");t.setAttribute("aria-expanded",!a),e.classList.toggle("is-open"),a?i.enableBodyScroll:i.disableBodyScroll};t.addEventListener("click",n),a.addEventListener("click",n),window.matchMedia("(min-width: 768px)").addEventListener("change",a=>{a.matches&&(e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1))})})();let n=document.querySelector(".fav-recipe-card-list"),r=document.querySelector(".fav-category-block"),l="favorite",c=JSON.parse(localStorage.getItem(l))??[];console.log(n),console.log(r);let s=c.map(e=>{console.log("recipe",e),e.category});e=c.length?c.map(({preview:e,title:t,description:a,rating:i,_id:n})=>{let r=a.slice(0,62),l=a.slice(0,97),c=l+"...";return window.screen.width>=768&&(c=r+"..."),`<div class="photo-card">
