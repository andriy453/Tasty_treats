function e(){let e=document.documentElement.getAttribute("data-theme"),t="light"===e?"dark":"light";document.documentElement.setAttribute("data-theme",t);let n=document.querySelectorAll(".input-switcher");n.forEach(function(e){e.checked="dark"===t}),localStorage.setItem("theme",t)}const t=document.querySelectorAll(".input-switcher");t.forEach(function(t){t.addEventListener("change",e)}),function(){let e=localStorage.getItem("theme"),t=window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light",n=e||t;document.documentElement.setAttribute("data-theme",n);let a=document.querySelectorAll(".input-switcher");a.forEach(function(e){e.checked="dark"===n})}();var n={};function a(e,t){let n;n=e.length?e.map(({preview:e,title:t,description:n,rating:a,_id:i})=>{let l=n.slice(0,62),o=n.slice(0,97),c=o+"...";return window.screen.width>=768&&(c=l+"..."),`<div class="photo-card">
      ...
      <p class="message-for-empty">
        ...
        </div>`,t.innerHTML=n}n={trueFunc:function(){return!0},falseFunc:function(){return!1}},(()=>{let e=document.querySelector(".js-menu-container"),t=document.querySelector(".js-open-menu"),a=document.querySelector(".js-close-menu"),i=()=>{let a="true"===t.getAttribute("aria-expanded");t.setAttribute("aria-expanded",!a),e.classList.toggle("is-open"),a?(n.enableBodyScroll,document.body.classList.remove("no-scroll")):(n.disableBodyScroll,document.body.classList.add("no-scroll"))};t.addEventListener("click",i),a.addEventListener("click",i),window.matchMedia("(min-width: 768px)").addEventListener("change",a=>{a.matches&&(e.classList.remove("is-open"),t.setAttribute("aria-expanded",!1),(0,n.enableBodyScroll)(e),document.body.classList.remove("no-scroll"))})})();const i=document.querySelector(".fav-recipe-card-list"),l=document.querySelector(".fav-category-block");document.querySelector(".btn-all-categori");const o="favorite",c=JSON.parse(localStorage.getItem(o))??[],s=c.map(e=>e.category);a(c,i),function(e){let t=[...new Set(e)];l.insertAdjacentHTML("afterbegin",'<button class="btn-all-categori  active_all-categories" type="button">All categories</button>'),l.insertAdjacentHTML("beforeend",t.map(e=>`
          <button class="fav-category-fltr-btn" id='${e}' type="button">${e}</button>`).join(""))}(s),i.addEventListener("click",function(e){if(e.target.classList.add("heart-icon-active"),"BUTTON"===e.target.tagName&&e.target.classList.contains("btn-heard")){let t=e.target.id,n=c.filter(e=>e._id!==t);e.target.classList.remove("heart-icon-active"),localStorage.setItem(o,JSON.stringify(n))}}),l.addEventListener("click",e=>{e.target.classList.contains("fav-category-fltr-btn")&&a(c.filter(t=>t.category===e.target.id),i),e.target.classList.contains("btn-all-categori")&&a(c,i)}),i.addEventListener("click",function(e){"BUTTON"===e.target.tagName&&("See recipe"===e.target.innerText&&console.log(e.target.innerText),e.target.classList.toggle("bnt"))});const d=document.getElementById("myModal"),r=document.getElementById("openModal"),u=document.getElementsByClassName("close")[0],m=document.querySelector(".modal-form-stl"),g=document.getElementById("messageBox");document.getElementById("messageText");const y=document.getElementById("okButton"),p=document.getElementById("thanksBox"),v=document.getElementById("closeThanksButton");r.addEventListener("click",()=>d.style.display="block"),u.onclick=function(){d.style.display="none",g.style.display="none",p.style.display="none"},window.onclick=function(e){e.target==d&&(d.style.display="none",g.style.display="none",p.style.display="none")},m.addEventListener("submit",function(e){e.preventDefault(),d.style.display="none",p.style.display="block"}),y.onclick=function(){g.style.display="none"},v.onclick=function(){p.style.display="none",m.reset()};
//# sourceMappingURL=favorites.f5f7384d.js.map
